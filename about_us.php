...
<html lang="en">
  ...
  <body oncontextmenu="return false">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6">
          <img class="img-fluid rounded mb-4" src="img/polatok_cover.jpg" alt="Polatok Cover">
        </div>
        <div class="col-lg-6">
          <h2>About Us</h2>
          <i><p>"Life is too short and just too precious to spend it rooted at one place.The journey of thousand miles begins with a single step."</p></i>
		  <h5 style="color: green">Our Speciality</h5>
          <p>When you chose Polatok as your travel partner, you will be able to discover many places, include lesser known places.We feature hotels,flights and manymore attractions to help you.</p>
          <h5 style="color: blue">Your Budget, Our Plan</h5>
		  <p>We understand your budget constraints. We are always ready to provide you customized plan as desired, since we follow our <strong>USP YOUR BUDGET, OUR PLAN</strong></p>
		</div>
      </div>
	  ...
	  <div class="row">
		<div class="col-lg-12">
			...
			<p>From troubles of finding hygienic place to stay to foods,Polatok is there for you to solve your travel woes, take you to an unforgettable journey! Start Now!</p>
		</div>
	  </div>
      <!-- /.row -->   
